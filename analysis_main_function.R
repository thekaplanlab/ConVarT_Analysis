...
analysis_main<-function(...){
  ...
  mutagen_aap<-numeric(50000000)
  mutagen_rfsq<-character(50000000)
  mutagen_sqsqsq<-numeric(50000000)
  mutagen_ind<-numeric(50000000)
  ...
  for (i in 1:length(table23)){
    ...
    if(length(mutagen_aapos>0)){
      # print(mutagen_aapos)
      # print(mutagen_sqsqsq_length+1)
      # print(mutagen_sqsqsq_length+length(mutagen_sssqq))
